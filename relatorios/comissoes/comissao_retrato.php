...
$busca = mysql_query("SELECT * FROM contratos WHERE comissao= 'P'");
$pdf = new PDF('P','mm','A4');
$pdf->Open();
$pdf->AddPage();
...
$pdf->SetX(90);
$pdf->Cell(40, 5, $resultado['datacadastro']);

$pdf->SetX(130);
$pdf->Cell(40, 5, $resultado['id_corretor']);
