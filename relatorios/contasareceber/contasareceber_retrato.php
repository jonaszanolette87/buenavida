...
function Header()
{
	...
	//Move to the right
	$this->Cell(40);
	$this->Cell(90,10,'Email: contato@LEDNORDESTEmoda.com.br',0,0,'L');
	$this->Ln(5);

	//Move to the right
	$this->Cell(40);
    $this->Cell(90,10,'contato@LEDNORDESTEmoda.com.br',0,0,'L');	
	$this->Ln(5);
	...
	$this->Ln(5);
	//assunto
	$this->SetSubject("Relatorio de Clientes");
	...
	$this->Cell(0,5,'www.LEDNORDESTEmoda.com.br',0,1,'R');
	$this->Cell(0,0,'',1,1,'L');
	$this->Ln(4);
