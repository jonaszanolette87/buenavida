...
<div id="rel_contasareceber">
  <p>RELATORIO DE CONTAS A RECEBER</p>
  <hr>
    <br>
    
  <form id="form1" name="form1" action="../relatorios/contasareceber/contasareceber_paisagem.php?pg=apagar" method="post">
...
<input type="submit" name="Enviar" id="Enviar" value=".::GERAR RELATORIO::." />
  ...
  <a href="../relatorios/contasareceber/contasareceber_paisagem.php" target="_blank"><br />
  </a></div>
<?php
