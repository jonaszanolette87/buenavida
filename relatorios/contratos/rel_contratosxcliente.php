...
<br />
<div id="rel_clientes">
  <p>RELATÓRIO DE CONTRATOS x CLIENTE</p>
  <hr>
    <form id="form1" name="form1" method="post" action="">
      Periodo :
      <label for="data_incial"></label>
      <input type="text" name="data_incial" id="data_1" />
      a
...
?>
  ...
  <input type="submit" name="Buscar" id="Buscar" value="Buscar" />
    ...
    <br>
  <a href="../relatorios/clientes/clientes_paisagem.php" target="_blank">Paisagem</a><br>
<a href="../relatorios/clientes/clientes_retrato.php" target="_blank">Retrato</a></div>
<?php
