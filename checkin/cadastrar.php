...
<script type="text/javascript">
  ...
  function diasDecorridos(dt1, dt2){
    ...
    // determina o fuso horÃ¡rio de cada objeto Date
    var fh1 = dt1.getTimezoneOffset();
    var fh2 = dt2.getTimezoneOffset(); 
    
    // retira a diferenÃ§a do horÃ¡rio de verÃ£o
    if(dt2 > dt1){
...
?>
          ...
          <tr valign="baseline">
            <td align="right" nowrap="nowrap">CAFÃ‰ DA MANHA:</td>
            <td><label>
          ...
          <tr valign="baseline">
            ...
            <td><input name="cobro_adiantamento" type="text" id="cobro_adiantamento"  onclick="soma_adiantado()" value="" size="20" onKeyUp="maskIt(this,event,'###.###.###,##',true)" dir="rtl"/></td>
          </tr>
          ...
          <tr valign="baseline">
            ...
            <option></option>
              <option value="CONFIRMADO">CONFIRMADO</option><option value="PRE RESERVADO">PRE RESERVADO</option>
				<option value="EM MANUTENCAO">EM MANUTENÃ‡ÃƒO</option>
          ...
          <tr valign="baseline">
            <td align="right" nowrap="nowrap">OBSERVAÃ‡Ã•ES:</td>
