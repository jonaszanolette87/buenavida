...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1") || ($_GET["id_compra"] == "novo")) {
  $insertSQL = sprintf("INSERT INTO compras_materiasprimas ( id_fornecedor, datacompra, status) VALUES ( %s, %s, %s)",
...
$insertGoTo = "../compras_materiasprimas/alterar.php?id=".$id_compra."&id_compra=".$id_compra.";";
...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="2">
    <tr>
      ...
      <th width="908" class="Titulo16">CADASTRA COMPRA MATERIAS PRIMAS:</th>
...
?>
      ...
      <tr valign="baseline">
        <td colspan="2" align="left" nowrap="nowrap"><iframe width="950px" height="300px" frameborder="0" src="../compras_materiasprimas_itens/index.php"></iframe></td>
      </tr>
      <tr valign="baseline">
        <th colspan="2" align="left" nowrap="nowrap">FECHAMENTO</th>
      </tr>
      <tr valign="baseline">
        <th colspan="2" align="left" nowrap="nowrap"><iframe width="950px" height="300px" frameborder="0" src="../compras_materiasprimas_fechamento/index.php"></iframe></th>
      </tr>
      <tr valign="baseline">
