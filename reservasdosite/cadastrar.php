...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  valor_realocacao,  comissao, valor_retido, cobro_adiantamento, status, 
...
?>
          ...
          <tr valign="baseline">
            ...
            <td><input name="valor_reserva" type="text" id="valor_reserva" value="" size="44" /></td>
          </tr>
          <tr valign="baseline">
          ...
          <tr valign="baseline">
            ...
            <td><input name="cobro_adiantamento" type="text" id="cobro_adiantamento"  onclick="soma_adiantado()" value="" size="20" /></td>
          </tr>
          <tr valign="baseline">
