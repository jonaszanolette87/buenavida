...
$query_seleciona_reservas = "SELECT * FROM reservasdosite 


WHERE  $campo LIKE '%".$buscar."%' ORDER BY chegada DESC";
...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="2">
    <tr>
      ...
      <th class="Titulo16"><strong><em><font color="#888888"> RESERVAS DO SITE:</font></em></strong></th>
    </tr>
</table>
...
CAMPO:
  ...
  <tr>
    ...
    <a href="#"  onClick="displayMessage('../reservas/cadastrar.php','800','640');return false"><img src="../imagens/add.png" width="20" height="20" alt="ADD" /></a>
  ...
  <tr>
    <td colspan="2"><table width="100%">
      <tr>
        ...
        <th width="4%"> NOME DO CLIENTE</th>
        <th width="5%">EMAIL</th>
        <th width="9%">TELEFONE</th>
        <th width="3%">DATA DA CHEGADA</th>
        <th width="3%">DATA DA SAÍDA</th>
      ...
      <tr class="claro" onmouseover="this.className='ativo';" onmouseout="this.className='claro';">
        ...
        <td><?php echo $row_seleciona_reservas['email']; ?></td>
        <td><?php echo $row_seleciona_reservas['telefone']; ?></td>
        <td>
        ...
        <td align="center">
          ...
          <a href=#"  onClick="displayMessage('../reservas/alterar.php?id=<?php echo $row_seleciona_reservas['id']; ?>','800','640');return false"><img src="../imagens/alterar.png" width="20" height="20" alt="alt" /></a>
