  ...
  <table width="659" cellpadding="5" cellspacing="2" style="border: 1px solid #444;">
    <tbody>
      <tr>
        ...
        <td>
<?php echo "ID : 000".$row_seleciona_reservas['id']; ?>
<?php echo " Data Reserva : ".databrasil($row_seleciona_reservas['data_reserva']); ?>
<p>RUA , Nº 7, <br />
          BAIRRO DE | CEP 60.040-000 <br />
      ...
      <tr>
        <td colspan="2"><br>
          ...
          else { echo $row_seleciona_reservas['nomecliente'];} ?> CPF :<?php if(isset($row_seleciona_reservas['cpf_cnpj'])){echo $row_seleciona_reservas['cpf'];}

         ?> </strong><br />
          <br>
          HOSPEDE 1 :   <strong>
          <?php if(isset($row_seleciona_reservas['nomecliente'])){echo $row_seleciona_reservas['hospede']." ";} ?>
CPF : <?php if(isset($row_seleciona_reservas['hospede_cpf'])){echo $row_seleciona_reservas['hospede_cpf'];}
         ?>
          </strong>   

          <?php if(isset($row_seleciona_reservas['hospede2'])){echo "<br>HOSPEDE 2: ".$row_seleciona_reservas['hospede2'];}
 ?>
CPF : <?php if(isset($row_seleciona_reservas['hospede_cpf2'])){echo $row_seleciona_reservas['hospede_cpf2'];}

?>
            <strong>
          <?php if(isset($row_seleciona_reservas['hospede3'])){echo "HOSPEDE 3: ".$row_seleciona_reservas['hospede3'];}

           ?>
          </strong>    <strong>
          <?php if(isset($row_seleciona_reservas['hospede4'])){echo "HOSPEDE 4: ".$row_seleciona_reservas['hospede4'];}
 ?>
          </strong>    <strong>
          <?php if(isset($row_seleciona_reservas['hospede5'])){echo "HOSPEDE 5: ".$row_seleciona_reservas['hospede5'];}

         ?>
          </strong>    <strong>
          <?php if(isset($row_seleciona_reservas['hospede6'])){echo "HOSPEDE 6: ".$row_seleciona_reservas['hospede6'];}
      ...
      <tr>
        <td colspan="2">NÚMERO DE ADULTOS : <strong><?php echo $row_seleciona_reservas['qtd_pass']; ?> </strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NUMERO DE NOITES <strong>:<?php echo $row_seleciona_reservas['n_noites']; ?></strong></td>
      </tr>


<tr>
        <td colspan="2">NÚMERO DE CRIANÇAS : <strong><?php echo $row_seleciona_reservas['n_criancas']; ?> </strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NUMERO DE CAMAS<strong>:<?php echo $row_seleciona_reservas['n_camas']; ?></strong>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;QTD TOTAL DE PESSOAS<strong>:<?php echo $row_seleciona_reservas['qtd_total']; ?></strong></td>
      </tr>
      ...
      <tr>
        <td colspan="2">VALOR TOTAL R$ : <strong><?php echo number_format($row_seleciona_reservas['valor_reserva'], 2, ',', '.'); ?> </strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;VALOR ADIANTADO: <strong><?php echo $row_seleciona_reservas['valor_retido']; ?></strong>   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;VALOR A COBRAR NO CHEK IN:<strong> <?php echo $row_seleciona_reservas['cobro_adiantamento']; ?></strong></td>
      </tr>
 <tr>
        <td colspan="2">VALOR RECEBIDO R$ : <strong><?php echo $row_seleciona_reservas['valor_recebido']; ?> </strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;VALOR DEVIDO: <strong><?php echo $row_seleciona_reservas['valor_devido']; ?></strong>   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
      </tr>
      <tr>
