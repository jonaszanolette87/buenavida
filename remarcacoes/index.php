...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="2">
    <tr>
      ...
      <th class="Titulo16"><strong><em><font color="#888888"> REMARCACOES:</font></em></strong></th>
    </tr>
</table>
  ...
  <tr>
    <td colspan="2"><table width="100%">
      <tr>
        ...
        <th width="6%">DATA RESERVA</th>
        <th width="12%"> NOME DO CLIENTE</th>
        <th width="6%">DATA DA CHEGADA</th>
        <th width="6%">DATA DA SAÍDA</th>

        <th width="6%">USER</th>
        <th width="1%">REMARCAR</th>
      ...
      <tr class="claro" onmouseover="this.className='ativo';" onmouseout="this.className='claro';">
        ...
        <td align="center">
          ...
          <a href=#"  onClick="displayMessage('../remarcacoes/alterar.php?id=<?php echo $row_seleciona_reservas['id']; ?>','800','440');return false"><img src="../imagens/alterar.png" width="20" height="20" alt="alt" /></a>
