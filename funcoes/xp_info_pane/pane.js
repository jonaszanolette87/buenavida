/************************************************************************************************************
	...
	*/
	var xpPanel_slideActive = false;	// Slide down/up active?
	...
	function initDhtmlgoodies_xpPane(panelTitles,panelDisplayed,cookieArray)
	{
		...
		for(var no=0;no<divs.length;no++){
			if(divs[no].className=='dhtmlgoodies_panel'){
				...
				img.src = 'funcoes/xp_info_pane/images/arrow_up1.gif';				
				...
				if(!panelDisplayed[dhtmlgoodies_paneIndex]){
					...
					img.src = 'funcoes/xp_info_pane/images/arrow_down1.gif';
				}
			...
			if(divs[no].className=='dhtmlgoodies_panel2'){
				...
				outerContentDiv.id = 'paneContent' + dhtmlgoodies_paneIndex;
				outerContentDiv.className = 'panel2Content';
				var topBar = document.createElement('DIV');
				topBar.onselectstart = cancelXpWidgetEvent;
				var span = document.createElement('SPAN');				
				span.innerHTML = panelTitles[dhtmlgoodies_paneIndex];
			...
			if(divs[no].className=='dhtmlgoodies_panel3'){
				...
				outerContentDiv.id = 'paneContent' + dhtmlgoodies_paneIndex;
				outerContentDiv.className = 'panel3Content';
				var topBar = document.createElement('DIV');
				topBar.onselectstart = cancelXpWidgetEvent;
				var span = document.createElement('SPAN');				
				span.innerHTML = panelTitles[dhtmlgoodies_paneIndex];
			...
			if(divs[no].className=='dhtmlgoodies_panel4'){
				...
				outerContentDiv.id = 'paneContent' + dhtmlgoodies_paneIndex;
				outerContentDiv.className = 'panel4Content';
				var topBar = document.createElement('DIV');
				topBar.onselectstart = cancelXpWidgetEvent;
				var span = document.createElement('SPAN');				
				span.innerHTML = panelTitles[dhtmlgoodies_paneIndex];
			...
			if(divs[no].className=='dhtmlgoodies_panel5'){
			...
			if(divs[no].className=='dhtmlgoodies_panel6'){
			...
			if(divs[no].className=='dhtmlgoodies_panel7'){
			...
			if(divs[no].className=='dhtmlgoodies_panel8'){
				...
				outerContentDiv.id = 'paneContent' + dhtmlgoodies_paneIndex;
				outerContentDiv.className = 'panel8Content';
				var topBar = document.createElement('DIV');
				topBar.onselectstart = cancelXpWidgetEvent;
				var span = document.createElement('SPAN');				
				span.innerHTML = panelTitles[dhtmlgoodies_paneIndex];
		...
		if(divs[no].className=='dhtmlgoodies_panel9'){
				...
				outerContentDiv.id = 'paneContent' + dhtmlgoodies_paneIndex;
				outerContentDiv.className = 'panel9Content';
				var topBar = document.createElement('DIV');
				topBar.onselectstart = cancelXpWidgetEvent;
				var span = document.createElement('SPAN');				
				span.innerHTML = panelTitles[dhtmlgoodies_paneIndex];
			...
			if(divs[no].className=='dhtmlgoodies_panel10'){
				...
				outerContentDiv.id = 'paneContent' + dhtmlgoodies_paneIndex;
				outerContentDiv.className = 'panel10Content';
				var topBar = document.createElement('DIV');
				topBar.onselectstart = cancelXpWidgetEvent;
				var span = document.createElement('SPAN');				
				span.innerHTML = panelTitles[dhtmlgoodies_paneIndex];
