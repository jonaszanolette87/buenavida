...
WHERE $campo LIKE '%".$buscar."%' AND  r.status ='HOSPEDADO'
...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="2">
    <tr>
      ...
      <th class="Titulo16"><strong><em><font color="#888888"> CHECKOUT:</font></em></strong></th>
    </tr>
</table>
  ...
  <tr>
    <td colspan="2"><table width="100%">
      <tr>
        ...
        <th width="6%">DATA DA SAIDA</th>
        <th width="6%">N DE NOITES</th>
        <th width="6%">APT</th>
        <th width="6%">PESSOAS</th>
        <th width="6%">VALOR DA RESERVA</th>
	...
	?></td>
        ...
        <td align="center">
          ...
          <a href=#"  onClick="displayMessage('../reservas/alterar.php?id=<?php echo $row_seleciona_reservas['id']; ?>','990','640');return false"><img src="../imagens/alterar.png" width="20" height="20" alt="alt" /></a>
